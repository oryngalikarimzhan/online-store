...
export default class CartPageTemplate implements ITemplate {
        ...
        <div class="cart-item__header">
            ...
            <div class="cart-item__page-control">
                <div class="cart-item__limit">
                    Items per page: 
                    <input type="number" class="limit" min="1" max="5">
                </div>
    ...
    <section class="cart-item__summary">
        <div class="promo">
            Промокод
            <input type="search" placeholder="Промокод" class="promocode">
        ...
        <div class="cart-summary">
            ...
            <span class="">
                <p>Оформляя заказ, вы подтверждаете свое согласие с нашими <a href="/cms/official">условиями покупки</a> в интернет-магазине</p>
            </span>
        </div>
        </div>
    </section>`;
